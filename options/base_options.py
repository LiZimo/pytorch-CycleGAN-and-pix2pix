...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='/mount/Users/zli/pix2pix_data/checkpoints', help='models are saved here')
        # model parameters
        ...
        parser.add_argument('--mask_path', type=str, default='/mount/Users/zli/stylegan2_data/raw_images/combined_masks', help='directory of masks')
